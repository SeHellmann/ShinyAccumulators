                ...
                sidebarPanel= sidebarPanel(
                  ...
                  bsCollapse(id = "settings", open = NULL,
                             bsCollapsePanel("Set model parameters", 
                                             fluidRow(
                                               column(6, tags$h4("Decision process parameters"),
                                                      tags$h5("Basic DDM parameters"),
                                                      ...
                                                      tags$h5("Variabilities in decision process"),
                                               ...
                                               column(6, tags$h4("Confidence parameters"),
                                                      tags$h5("Visibility process"),
                                                      ...
                                                      tags$h5("Confidence computation"),
